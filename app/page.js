                ...
                <CardHeader className="gap-6">
                  <div className="flex flex-col items-center gap-6 lg:flex-row">
                    ...
                    <div className="flex flex-col items-center gap-2 lg:items-start">
                      ...
                      <div className="flex items-center justify-center mt-4 lg:items-start lg:justify-start gap-x-2">
                        <Badge className="flex gap-1"><BsFillPersonFill /> {userData.followers} Followers</Badge>
                        <Badge className="flex gap-1"><BsPersonFillCheck /> {userData.following} Following</Badge>
